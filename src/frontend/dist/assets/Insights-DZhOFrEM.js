import { c as createLucideIcon, ag as commonjsGlobal, ah as getDefaultExportFromCjs, r as reactExports, ai as clsx, aj as React, ak as invariant, h as useActor, b as useQuery, j as jsxRuntimeExports, S as Skeleton, m as motion, al as ChartNoAxesColumn, C as Card, k as CardHeader, l as CardTitle, e as CardContent, i as createActor } from "./index-Chdf2p0o.js";
...
function MoodTrendChart({ entries }) {
  const data = reactExports.useMemo(() => {
    ...
    for (const e3 of entries) {
      byDate.set(e3.date, Number(e3.score));
    }
    return Array.from({ length: 30 }, (_, i) => {
      const d2 = daysAgo(29 - i);
      const dateStr = toDateStr(d2);
      const label = d2.toLocaleDateString("en", {
        month: "short",
        day: "numeric"
      });
  ...
  if (entries.length === 0) {
    return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex h-32 items-center justify-center text-muted-foreground text-sm", children: "No mood entries in the last 30 days" });
  }
  return /* @__PURE__ */ jsxRuntimeExports.jsx(ResponsiveContainer, { width: "100%", height: 200, children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
    AreaChart,
    {
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("defs", { children: /* @__PURE__ */ jsxRuntimeExports.jsxs("linearGradient", { id: "moodGrad", x1: "0", y1: "0", x2: "0", y2: "1", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          Tooltip,
          {
            ...
            formatter: (v2) => v2 != null ? [v2, "Mood score"] : ["No entry", ""]
          }
        ),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          Area,
...
function MoodDistribution({ entries }) {
  const data = reactExports.useMemo(() => {
    ...
    for (const e3 of entries) {
      const s2 = Number(e3.score);
      if (s2 >= 1 && s2 <= 5) counts[s2 - 1]++;
    }
  ...
  if (entries.length === 0) {
    return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex h-32 items-center justify-center text-muted-foreground text-sm", children: "No mood data yet" });
  }
  return /* @__PURE__ */ jsxRuntimeExports.jsx(ResponsiveContainer, { width: "100%", height: 180, children: /* @__PURE__ */ jsxRuntimeExports.jsxs(BarChart, { data, margin: { top: 4, right: 8, left: -20, bottom: 0 }, children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      CartesianGrid,
      {
        strokeDasharray: "3 3",
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      Tooltip,
      {
        ...
        formatter: (v2) => [v2, "Days"]
      }
    ),
    /* @__PURE__ */ jsxRuntimeExports.jsx(Bar, { dataKey: "count", radius: [4, 4, 0, 0], children: data.map((d2) => /* @__PURE__ */ jsxRuntimeExports.jsx(Cell, { fill: MOOD_COLORS[d2.score - 1] }, d2.score)) })
  ] }) });
}
function HeatmapCell({ rate }) {
  const bg = rate === null ? "bg-muted/40" : rate === 0 ? "bg-muted/60" : rate < 0.5 ? "bg-primary/25" : rate < 1 ? "bg-primary/55" : "bg-primary";
...
function HabitHeatmap({
  ...
  const cells = reactExports.useMemo(() => {
    const activeHabitIds = new Set(
      habits.filter((h2) => !h2.isArchived).map((h2) => h2.id)
    );
    const habitCount = activeHabitIds.size;
    return Array.from({ length: 56 }, (_, i) => {
      const d2 = daysAgo(55 - i);
      const dateStr = toDateStr(d2);
      if (habitCount === 0) return { date: dateStr, rate: null };
      const dayCompletions = completions.filter(
        (c2) => c2.date === dateStr && activeHabitIds.has(c2.habitId)
      );
      const completed = dayCompletions.filter((c2) => c2.completed).length;
      return { date: dateStr, rate: completed / habitCount };
    });
  }, [completions, habits]);
  const days = ["Sun", "Mon", "Tue", "Wed", "Thu", "Fri", "Sat"];
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-2", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-7 gap-1", children: days.map((d2) => /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-center text-xs text-muted-foreground", children: d2.charAt(0) }, d2)) }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-7 gap-1", children: cells.map((cell) => /* @__PURE__ */ jsxRuntimeExports.jsx(HeatmapCell, { rate: cell.rate }, cell.date)) }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 pt-1", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs text-muted-foreground", children: "Less" }),
      ["none", "zero", "low", "mid", "full"].map((label, i) => {
        const r = [null, 0, 0.25, 0.6, 1][i];
        return /* @__PURE__ */ jsxRuntimeExports.jsx(HeatmapCell, { rate: r }, label);
      }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs text-muted-foreground", children: "More" })
    ] })
  ] });
}
function StreakLeaderboard({
  ...
  const ranked = reactExports.useMemo(() => {
    return habits.filter((h2) => !h2.isArchived).map((h2) => {
      const streak = streaks.find((s2) => s2.habitId === h2.id);
      return {
        habit: h2,
        current: Number((streak == null ? void 0 : streak.currentStreak) ?? 0),
        longest: Number((streak == null ? void 0 : streak.longestStreak) ?? 0)
      };
    }).sort((a2, b2) => b2.current - a2.current);
  }, [habits, streaks]);
  if (ranked.length === 0) {
    return /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-muted-foreground py-4 text-center", children: "No habits yet. Start one to see your streaks!" });
  }
  return /* @__PURE__ */ jsxRuntimeExports.jsx("ul", { className: "space-y-2", children: ranked.map(({ habit, current, longest }, idx) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "li",
    {
      className: "flex items-center gap-3 rounded-lg bg-muted/30 px-3 py-2.5",
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "w-5 text-sm font-bold text-muted-foreground", children: idx + 1 }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-lg", children: habit.icon }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "flex-1 text-sm font-medium text-foreground min-w-0 truncate", children: habit.name }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-1 text-sm font-semibold text-primary", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(Flame, { className: "h-4 w-4" }),
          current,
          "d"
        ] }),
        longest > current && /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "text-xs text-muted-foreground", children: [
          "best: ",
          longest,
          "d"
        ] })
...
function WeeklySummary({
  ...
  const summary = reactExports.useMemo(() => {
    ...
    const moodCount = moodEntries.filter(
      (e3) => e3.date >= weekAgo && e3.date <= today
    ).length;
    const activeHabits = habits.filter((h2) => !h2.isArchived);
    const possibleCompletions = activeHabits.length * 7;
    const weekCompletions = completions.filter(
      (c2) => c2.date >= weekAgo && c2.date <= today && c2.completed
    ).length;
    const habitPct = possibleCompletions > 0 ? Math.round(weekCompletions / possibleCompletions * 100) : 0;
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "rounded-xl bg-primary/8 border border-primary/20 px-5 py-4 space-y-1", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-sm font-medium text-foreground", children: [
      "This week you logged moods ",
      /* @__PURE__ */ jsxRuntimeExports.jsx("strong", { children: summary.moodCount }),
      " time",
      summary.moodCount !== 1 ? "s" : "",
      " and completed",
      " ",
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-muted-foreground", children: summary.msg })
  ] });
}
function Insights() {
  ...
  const { data: streaks = [], isLoading: streaksLoading } = useQuery({
    queryKey: [
      "habitStreaks",
      habits.map((h2) => String(h2.id)).join(","),
      today
    ],
    queryFn: async () => {
      if (!actor || habits.length === 0) return [];
      const active = habits.filter((h2) => !h2.isArchived);
      return Promise.all(active.map((h2) => actor.getHabitStreak(h2.id, today)));
    },
  ...
  const bestStreak = reactExports.useMemo(() => {
    ...
    const best = streaks.reduce(
      (max2, s2) => s2.longestStreak > max2.longestStreak ? s2 : max2,
      streaks[0]
    );
    const habit = habits.find((h2) => h2.id === best.habitId);
    return { habit, streak: Number(best.longestStreak) };
  }, [streaks, habits]);
  const isLoading = moodLoading || habitsLoading || completionsLoading || streaksLoading;
  if (isLoading) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-6 pb-10", "data-ocid": "insights-page", children: [
      ...
      motion.div,
      {
        ...
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(ChartNoAxesColumn, { className: "h-6 w-6 text-primary" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "font-display text-3xl font-bold text-foreground", children: "Insights" })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground", children: "A warm look at your mood and habit trends over time." })
        ]
      }
    ),
    /* @__PURE__ */ jsxRuntimeExports.jsx(
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-1 md:grid-cols-2 gap-5", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        motion.div,
        {
          ...
          children: /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { className: "shadow-soft h-full", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx(CardContent, { "data-ocid": "mood-trend-chart", children: /* @__PURE__ */ jsxRuntimeExports.jsx(MoodTrendChart, { entries: moodEntries }) })
          ] })
        }
      ),
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        motion.div,
        {
          ...
          children: /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { className: "shadow-soft h-full", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx(CardContent, { "data-ocid": "mood-distribution-chart", children: /* @__PURE__ */ jsxRuntimeExports.jsx(MoodDistribution, { entries: moodEntries }) })
          ] })
        }
      ),
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        motion.div,
        {
          ...
          children: /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { className: "shadow-soft h-full", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(CardHeader, { className: "pb-2", children: /* @__PURE__ */ jsxRuntimeExports.jsx(CardTitle, { className: "font-display text-base", children: "Habit Completion (8 weeks)" }) }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(CardContent, { "data-ocid": "habit-heatmap", children: habits.length === 0 ? /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-muted-foreground py-4 text-center", children: "No habits to display yet" }) : /* @__PURE__ */ jsxRuntimeExports.jsx(HabitHeatmap, { completions, habits }) })
          ] })
        }
      ),
      /* @__PURE__ */ jsxRuntimeExports.jsxs(
        motion.div,
        {
          ...
          className: "space-y-4",
          children: [
            bestStreak && bestStreak.streak > 0 && /* @__PURE__ */ jsxRuntimeExports.jsx(
              Card,
              {
                className: "shadow-soft border-primary/30 bg-primary/5",
                "data-ocid": "best-streak",
                children: /* @__PURE__ */ jsxRuntimeExports.jsx(CardContent, { className: "pt-4 pb-3", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx(Award, { className: "h-8 w-8 text-primary flex-shrink-0" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground uppercase tracking-wide font-medium", children: "All-Time Best Streak" }),
                    /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-xl font-bold text-foreground font-display", children: [
                      bestStreak.streak,
                      " days",
                      bestStreak.habit && /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "ml-2 text-base font-normal text-muted-foreground", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { className: "shadow-soft", children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx(CardContent, { "data-ocid": "streak-leaderboard", children: /* @__PURE__ */ jsxRuntimeExports.jsx(StreakLeaderboard, { habits, streaks }) })
            ] })
          ]
        }
      )
